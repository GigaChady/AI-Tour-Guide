from schemas import NarrationMessage, Poi, PreferencesEvent
...
def mock_pois(session_id: str, lat: float, lng: float) -> list[Poi]:
    return [
        Poi(
            ...
            photos=[mock_image_url("Mock Museum", "utils/assets/mock_images/museum_mock.jpg")],
        )
    ]
...
def mock_image_url(poi_name: str, filepath: str) -> str:
